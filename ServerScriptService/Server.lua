...
local Location = "New Beford" --E.g: "London", "New York", "Paris", "Tokyo" - You may go into more detail. E.g: Tusayan
		...
		CloudsModule.Clouds:new(
			{
				Tallness = 40; 
				Offset = 0; 
				Density = data.days[1].cloudcover / 100; 
				Speed = data.days[1].windspeed; 
				Height = Heightcalculation; 
				Size = EstimatedSizeCalculation,
				ShadowCast = false; --Down to personal preference.
				CloudType = "Cumulus" 
			})		
